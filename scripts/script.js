...
function init(){
    ...
    var placemark_1 = new ymaps.Placemark([53.31500795, 28.64318814], {
        balloonContentHeader: 'Сумченко Степан Сергеевич',
    ...
    var placemark_2 = new ymaps.Placemark([53.30841212, 28.63420868], {
        balloonContentHeader: 'Борис Михайлович Дмитриев',
    ...
    var placemark_3 = new ymaps.Placemark([53.30871697, 28.64157221], {
        balloonContentHeader: 'Римма Владимировна Кунько',
    ...
    var placemark_4 = new ymaps.Placemark([53.30635665, 28.64452638], {
        balloonContentHeader: 'Николай Филиппович Королёв',
        balloonContent: "<div id='text_br'>Николай Филиппович Королёв (01 июля 1906, д. Аминовичи, Могилёвская губерния, Российская империя — 07 апреля 1972, Могилёв, СССР) — советский военный и партийный деятель, генерал-майор (1943), Герой Советского Союза (1970).</div>",
    }, {
        iconLayout: 'default#image',
        iconImageHref: 'images/pm.png',
        iconImageSize: [47, 67],
    ...
    var placemark_5 = new ymaps.Placemark([53.30626823, 28.64116264], {
        balloonContentHeader: 'Каданчик Сергей Николаевич',
    ...
    var placemark_6 = new ymaps.Placemark([53.30159582, 28.66239669], {
        balloonContentHeader: 'Фёдор Андреевич Крылович',
